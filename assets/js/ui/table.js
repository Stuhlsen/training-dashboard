/* ============================================================
   UI/TABLE.JS — Fahrtenbuch: Filter, Suche, Sort, Render
   GitHub-Zugriff (Befinden-Speichern) läuft über ui/github-client.js.
   ============================================================ */
...
export const Subjective = {
  ...
  async load() {
    this._data = await fetchRawJson("data/subjective.json");
    return this._data;
  },
