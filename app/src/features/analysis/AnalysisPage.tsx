          ...
          <>
            ...
            {vm.groups.map((g) => (
              <section key={g.key} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                ...
                <TraceCard lanes={g.lanes} r0={r0} r1={r1} totalDays={vm.N} todayIdx={vm.todayIdx} eventIdx={vm.eventIdx} formatDay={vm.formatDay} dense={dense} rideOnDay={vm.rideOnDay} />
