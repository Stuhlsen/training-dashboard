 ...
 */
export function weekLabelForDate(cards, date, excludeId, athleteId, offsetWeeks = 0, weekModel = null) {
  if (!date) return null;
  ...
  const model = planWeekFor(athleteId, date, offsetWeeks, weekModel);
