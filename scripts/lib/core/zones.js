/* ============================================================
   ...
   assets/js/core/zones.js kopiert, damit scripts/ (buildfrei, reines Node)
   unabhängig von app/src/core/ läuft — dessen Fassung leitet die
   Zonen-Konstanten inzwischen aus app/src/sports/cycling/zones.ts ab
   (echtes TypeScript, ohne Build-Schritt für node nicht ladbar). Wird
   COGGAN_ZONE_UPPER_PCT/SWEET_SPOT_PCT/IF_BANDS dort neu kalibriert, muss
   diese Datei von Hand nachgezogen werden — sonst klassifiziert der Sync
   Fahrten mit veralteten Zonengrenzen, während die React-App live mit den
   neuen rechnet. Kein automatischer Abgleich vorhanden.
   ============================================================ */
